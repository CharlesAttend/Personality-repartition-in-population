...
# On observe que la moyenne pour "C" est environ 3.2
...
# <div style="color: darkred; font-size: medium">Le <u>Profile-Type</u> a donc un résultat au test, en moyenne de <strong>3.1</strong> pour les questions de type <strong>"E"</strong> et <strong>"N"</strong>, de <strong>3.2</strong> pour les questions de type <strong>"A"</strong> et <strong>"C"</strong> et de <strong>3.3</strong> pour les questions de type <strong>"O"</strong>. De plus, la personnalité définie pour ce profil est <strong>'N'</strong>.</div>

# In[3]:


Donnée = {'Race':  ['Caucasian (European)'],'Age': ['26,3'],'Native language':  ['English'],'Gender':  ['Female'],'Hand':  ['Right'],'Where is he from':  ['from another page on the test website'],'Country':  ['United States'],'E':  ['3.1'],'N':  ['3.1'],'A':  ['3.2'],'C':  ['3.2'],'O':  ['3.3'],'Personality_type': ['N']}
